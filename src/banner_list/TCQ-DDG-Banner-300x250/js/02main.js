...
App_banner.fn.anima = function() {
    ...
    function animate() {
        ...
        TweenLite.to(frame2_bubble, 0.3, { delay: '0.3', scale: 1.1, opacity: 1, ease: Power1.easeOut, transformOrigin: 'center bottom' });
        TweenLite.to(frame2_txt, 0.4, { delay: '0.8', top: 0, opacity: 1, ease: 'none' });

        TweenLite.to(man, 0.3, { delay: '4.55', right: -120, ease: 'none' });
        ...
        TweenLite.to(doctor, 0.3, { delay: '4.9', right: 2, ease: 'none' });
        ...
        TweenLite.to(ctaBlock, 0.4, { delay: '6.3', left: 22, opacity: 1, ease: 'none' });

        TweenLite.to(doctor, 0.3, { delay: '8.7', right: -136, ease: 'none' });
        ...
        TweenLite.to(frame4, 0.5, { delay: '9.2', left: 21, ease: Power1.easeOut });
        TweenLite.to(frame4, 0.3, { delay: '12.7', opacity: 0, ease: Power1.easeOut });

        TweenLite.to(doctor, 0, { delay: '13', top: 51, ease: 'none' });
        TweenLite.to(doctor, 0.3, { delay: '13.1', right: -26, ease: 'none' });
