...
App_banner.fn.anima = function() {
    ...
    animate();
    function animate() {
        TweenLite.to(man, 0.3, { delay: '0.5', right: -250, ease: 'none' });
        TweenLite.to(frame2_bubble, 0.3, { delay: '0.3', scale: 1, opacity: 1, ease: Power1.easeOut, transformOrigin: 'center bottom' });
        TweenLite.to(frame2_txt, 0.4, { delay: '0.8', top: 0, opacity: 1, ease: 'none' });

        TweenLite.to(man, 0.3, { delay: '4.55', right: -500, ease: 'none' });
        ...
        TweenLite.to(doctor, 0.3, { delay: '4.9', left: 70, ease: 'none' });
        ...
        TweenLite.to(ctaBlock, 0.4, { delay: '6.3', left: 488, opacity: 1, ease: 'none' });
        ...
        TweenLite.to(frame4, 0.5, { delay: '9.2', left: 185, ease: Power1.easeOut });
