...
App_banner.fn.anima = function() {
    ...
    tl.addLabel('frame1', '+=0')
        ...
        .addLabel('frame2', '+=0')
        .to(f1bg, 2, { scale: 1.14, x: 8, y: 13, ease: Power0.easeIn }, 'frame2+=0')
        ...
        // .to(f3gradient, 0.5, {opacity: 0.72, ease:Power0.easeIn}, 'frame4+=4')
        .to(f5txt, 0.5, { opacity: 1, ease: Power0.easeIn }, 'frame4+=4')
        .to(avastin_logo, 0.5, { opacity: 1, ease: Power0.easeIn }, 'frame4+=4')
        .to(tecentriq_logo, 0.5, { x: -172, y: 10, width: 129, height: 40, ease: Power0.easeIn }, 'frame4+=4')
