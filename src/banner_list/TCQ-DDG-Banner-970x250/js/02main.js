...
App_banner.fn.anima = function() {
    ...
    animate();
    function animate() {
        TweenLite.to(man, 0.3, { delay: '0.5', left: 380, ease: 'none' });
        ...
        TweenLite.to(man, 0.3, { delay: '4.55', left: 650, ease: 'none' });
        ...
        TweenLite.to(doctor, 0.3, { delay: '4.9', left: 80, ease: 'none' });
        ...
        TweenLite.to(ctaBlock, 0.4, { delay: '6.3', left: 466, opacity: 1, ease: 'none' });
        ...
        TweenLite.to(frame4, 0.5, { delay: '9.2', left: 235, ease: Power1.easeOut });
