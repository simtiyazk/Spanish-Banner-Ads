...
App_banner.fn.anima = function() {
    ...
    animate();
    function animate() {
        TweenLite.to(man, 0.3, { delay: '0.5', right: -50, ease: 'none' });
        ...
        TweenLite.to(man, 0.3, { delay: '4.55', right: -250, ease: 'none' });
        ...
        TweenLite.to(doctor, 0.3, { delay: '4.9', left:8, ease: 'none' });
        ...
        TweenLite.to(ctaBlock, 0.4, { delay: '6.3', left: 278, opacity: 1, ease: 'none' });

        TweenLite.to(doctor, 0.3, { delay: '8.7', left:-108, ease: 'none' });
        ...
        TweenLite.to(frame4, 0.5, { delay: '9.2', left: 18, ease: Power1.easeOut });
